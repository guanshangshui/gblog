---
date_modified: 2026-01-26 10:51:47
---
...
- 分享构建 AI 代理系统的实践经验，包括 KV 缓存优化、上下文管理、文件系统作为上下文等核心技术


- awesome-context-engineering
- [https://github.com/yzfly/awesome-context-engineering/blob/main/README_CN.md](https://github.com/yzfly/awesome-context-engineering/blob/main/README_CN.md)
- AI 上下文工程相关资源的精选列表，涵盖提示工程、上下文管理等内容


- 只要跟它说话——智能工程的无废话方式
- [https://steipete.me/posts/just-talk-to-it](https://steipete.me/posts/just-talk-to-it)
- 分享使用 AI 编程工具（codex cli）的实战经验，包括并行运行多个 Agent、管理爆炸半径等实用技巧


- Killer Code
- [https://cc.deeptoai.com/docs](https://cc.deeptoai.com/docs)
- ClaudeCode 最佳实践、社区技巧和工具的综合指南，提供智能编程的有效模式


- 一次性软件与被压缩的现实：AI Native 的本质是策略重构
- [https://yage.ai/ai-native-cost-structure.html](https://yage.ai/ai-native-cost-structure.html)
- 深入探讨 AI 时代软件开发范式的转变，从一次性软件的概念出发，分析如何通过 AI 降低代码成本来实现决策解析度的提升和现实的解压缩


- Opus 4.5 正在改变一切
- [https://burkeholland.github.io/posts/opus-4-5-change-everything/](https://burkeholland.github.io/posts/opus-4-5-change-everything/)
...
- [https://vikingz.me/first-100-dollars/](https://vikingz.me/first-100-dollars/)
- 详细记录独立开发者出海产品的冷启动过程，包括在 Reddit、HackerNews 等平台的推广策略和真实数据


- 独立开发穷鬼套餐(Web实践篇)
- [https://guangzhengli.com/blog/zh/indie-hacker-poor-stack](https://guangzhengli.com/blog/zh/indie-hacker-poor-stack)
...
- 如何提问才能进阶成为前端大神？
- [https://www.zhangxinxu.com/wordpress/2015/05/how-to-ask-web-front-question/](https://www.zhangxinxu.com/wordpress/2015/05/how-to-ask-web-front-question/)
- 张鑫旭分享的高效技术提问之道，教你如何通过邮件正确描述问题、提供上下文和 Demo
...
- 1key cdkey
- [https://afdian.com/item/18762e66c94911f08c3552540025c377](https://afdian.com/item/18762e66c94911f08c3552540025c377)
- 来自 updownup 的 cdkey 购买服务
